...
import Form from '@/pages/Role/components/View.vue';
...
const breadcrumbs = computed((): BreadcrumbItem[] => [
    ...
    {
        title: trans('role.bread_crumb.role_detail'),
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <BackButton :href="route('roles.index')" :label="isEditMode ? trans('role.title.view_role') : trans('role.title.create_role')" />
